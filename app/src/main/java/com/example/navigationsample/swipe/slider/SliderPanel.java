package com.example.navigationsample.swipe.slider;
...
public class SliderPanel extends FrameLayout {
    ...
    private int decorViewLeftOffset;
    ...
    public SliderPanel(Context context, View decorView, SliderConfig config) {
        ...
        this.config = (config == null ? new SliderConfig.Builder().build() : config);
        init();
    }
    ...
    public boolean onInterceptTouchEvent(MotionEvent ev) {
        ...
        List<View> views = config.getTouchDisabledViews();
        for(View view: views) {
    ...
    public void computeScroll() {
        ...
        if (dragHelper.continueSettling(true)) {
            ...
            decorViewLeftOffset = decorView.getLeft();
        }
    }
    ...
    /**
     * Get the default {@link com.example.navigationsample.swipe.model.SliderInterface} from which to control the panel with after attachment
     */
    public SliderInterface getDefaultInterface() {
        return defaultSliderInterface;
    }


    private final SliderInterface defaultSliderInterface = new SliderInterface() {

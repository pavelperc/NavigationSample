...
import com.example.navigationsample.swipe.model.SliderPosition;
...
final class ScrimRenderer {
    ...
    void render(Canvas canvas, SliderPosition position, Paint paint) {
        switch (position) {
            case LEFT:
    ...
    Rect getDirtyRect(SliderPosition position) {
        switch (position) {
            case LEFT:
